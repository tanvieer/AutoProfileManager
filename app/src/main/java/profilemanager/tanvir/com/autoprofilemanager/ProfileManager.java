...
//=================================================pROFILE===========================================
    ...
    private void ChangeProfile(){
        ...
        if( MyCallReciver.callCounter < 5 && value_lightLux<10 &&   myAudioManager.getRingerMode() != AudioManager.RINGER_MODE_VIBRATE) {
        ...
        else if ( value_lightLux>500 && myAudioManager.getRingerMode() != AudioManager.RINGER_MODE_NORMAL){
            myAudioManager.setRingerMode(AudioManager.RINGER_MODE_NORMAL);
            Log.d("numrcv", "  PROFILE MANAGER counter3  = " + MyCallReciver.callCounter);
        }
        if (MyCallReciver.callCounter > 4 && myAudioManager.getRingerMode() != AudioManager.RINGER_MODE_NORMAL){
            myAudioManager.setRingerMode(AudioManager.RINGER_MODE_NORMAL);

            Log.d("numrcv", "  PROFILE MANAGER counter4  = " + MyCallReciver.callCounter);
        }
