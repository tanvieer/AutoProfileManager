...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_NAME + "(" + KEY_ID + " INTEGER PRIMARY KEY," + COL_2 + " TEXT" + COL_3 + " TEXT" +")";
    SQLiteDatabase db;
    ...
    public boolean insertData(String result , String time){
